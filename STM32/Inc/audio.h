...
#define AUDIO_VOLUME_SSTV   ((q15_t)(0.9 * 32767)) // peak volume in Q15
#define AUDIO_VOLUME_PSK    ((q15_t)(0.4 * 32767)) // peak volume in Q15
#define AUDIO_VOLUME_MORSE  ((q15_t)(0.9 * 32767)) // peak volume in Q15
